        ...
        if ($this.find($slide).length > 1) {
          ...
          // Auto: false
            ...
            $slide.each(function (i) {
              var n = i + 1;
              t +=
                '<li id="helpSlide_'+i+'" style="list-style:none; font-size:18px; padding-top:5px; float:left; margin-left:10px; margin-top:3px; width:34px; height:30px; background-image:url(./images/buttonForNumber.png);">' +
                '<a style="width:34px;height:34px;display:block;  text-decoration:none; color:black;" href="#' + slideClassPrefix + n + '"' +'>' + n + '</a>' +
                '</li>';
            });
            $pagination.append(t);
